...
class RegisterHWNodeRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RegisterHWNodeRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RegisterHWNodeRequest
    let len;
    let data = new RegisterHWNodeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RegisterHWNodeRequest(null);
...
class RegisterHWNodeResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RegisterHWNodeResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RegisterHWNodeResponse
    let len;
    let data = new RegisterHWNodeResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RegisterHWNodeResponse(null);
...
module.exports = {
  Request: RegisterHWNodeRequest,
  Response: RegisterHWNodeResponse,
  md5sum() { return '0df1a079a9a4e3ccb2fd3852ded39c15'; },
  datatype() { return 'data_handler/RegisterHWNode'; }
};
